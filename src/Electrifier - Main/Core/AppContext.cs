	...
	public sealed class AppContext : ApplicationContext, IPersistent {
		...
		public void SaveConfiguration(string fileName) {
			...
			xmlDocument.AppendChild(xmlDocument.CreateComment("\nElectrifier main configuration file.\n\n" +
				...
				"For more information about electrifier, please visit www.electrifier.org.\n\n" +
				"DO NOT EDIT THIS FILE MANUALLY, CHANGES MAY CAUSE THE\n" +
				"CONTAINED CONFIGURATION INFORMATION BECOME CORRUPTED!\n\n" +
				"(c) 2004 electrifier.org, Thorsten Jung\n"));
		...
		public XmlNode CreatePersistenceInfo(XmlDocument xmlDocument, string prefix, string nmspURI) {
			...
			XmlNode appContextNode = xmlDocument.CreateElement(prefix, "AppContext", nmspURI);
