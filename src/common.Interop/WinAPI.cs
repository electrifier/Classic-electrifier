...
namespace electrifier.Win32API
{
    ...
    {       // ImageList_Draw fStyle-enumeration
        NORMAL = 0x00000000,
    ...
    {           // TreeView SetImageList-message constants
        NORMAL = 0,
        STATE = 2,
    }
    ...
    public enum LVSIL : uint
    {           // ListView SetImageList-message constants
        NORMAL = 0,
        SMALL = 1,
        STATE = 2,
    }
    ...
    {           // TreeView GetNextItem-message constants
        ROOT = 0x0000,
        NEXT = 0x0001,
        PREVIOUS = 0x0002,
        PARENT = 0x0003,
    ...
    /// <summary>
    /// Helper object for dealing with HTREEITEM-handles of TreeView-nodes
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct HTREEITEM
    {
        public IntPtr Handle { get; private set; }
        public bool IsValid { get { return !this.Handle.Equals(IntPtr.Zero); } }
    ...
    {               //TODO: Marshaling pruefen (typedef struct tagTVITEMEX)
